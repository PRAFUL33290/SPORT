    ...
    <>
      ...
      <nav className="fixed top-0 w-full z-[100] bg-black/60 backdrop-blur-2xl border-b border-white/5">
        <div className="max-w-7xl mx-auto flex justify-between items-center px-6 py-5">
          <a className="text-2xl font-black italic tracking-tighter text-cyan-400 font-space-grotesk flex items-center gap-2" href="#">
          ...
          <div className="hidden md:flex items-center gap-10 font-space-grotesk tracking-tight text-sm uppercase font-bold">
            <a className="text-cyan-400 relative after:content-[''] after:absolute after:-bottom-1 after:left-0 after:w-full after:h-0.5 after:bg-cyan-400" href="#">Programmes</a>
            <a className="text-white/50 hover:text-white transition-all" href="#">Coachs</a>
            <a className="text-white/50 hover:text-white transition-all" href="#">Tarifs</a>
            <a className="text-white/50 hover:text-white transition-all" href="#">Contact</a>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-16">
          ...
          <div>
            ...
            <ul className="space-y-5 text-sm font-bold">
              <li><a className="text-neutral-500 hover:text-primary-container transition-all flex items-center gap-2 group" href="#"><span className="w-1 h-1 bg-primary-container rounded-full opacity-0 group-hover:opacity-100 transition-opacity"></span> Programmes</a></li>
              <li><a className="text-neutral-500 hover:text-primary-container transition-all flex items-center gap-2 group" href="#"><span className="w-1 h-1 bg-primary-container rounded-full opacity-0 group-hover:opacity-100 transition-opacity"></span> Coachs</a></li>
              <li><a className="text-neutral-500 hover:text-primary-container transition-all flex items-center gap-2 group" href="#"><span className="w-1 h-1 bg-primary-container rounded-full opacity-0 group-hover:opacity-100 transition-opacity"></span> Tarifs</a></li>
              <li><a className="text-neutral-500 hover:text-primary-container transition-all flex items-center gap-2 group" href="#"><span className="w-1 h-1 bg-primary-container rounded-full opacity-0 group-hover:opacity-100 transition-opacity"></span> Contact</a></li>
            </ul>
          </div>
          <div>
